...
var getWidthRatioFromHeight = function getWidthRatioFromHeight(heightValue) {
...
export var Logo = function Logo(_ref) {
  var textColor = _ref.textColor,
      ...
      label = _ref.label,
      size = _ref.size;
  var widthValue = getWidthRatioFromHeight(size);
  return React.createElement("svg", {
    width: widthValue,
    height: size,
    viewBox: "0 0 ".concat(widthValue, " ").concat(size),
    fill: "none"
  }, React.createElement("title", null, label), React.createElement("path", {
